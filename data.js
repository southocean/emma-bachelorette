...
window.PLACES = [
  ...
  },
  {
    ...
    what: 'The trip\'s one fixed booking. On weekends Quê Em puts out a full Vietnamese buffet: bánh mì, phở, summer rolls, noodle and rice dishes, plus desserts and drinks. It runs 11:00–15:00 on Saturday, 2 minutes from Narinkkatori: the biggest meal of the day, right before the busiest afternoon.',
  ...
  },
  {
    ...
    what: 'The most famous stairs in Finland. Learn a 20-second routine on Friday night (Emma picks the song, obviously) and film it on the Cathedral steps, all four of you. Free, silly, and the kind of video that gets replayed at the wedding.',
...
window.PLAN = {
  ...
  sat: {
    ...
    note: 'One full day. Each energetic block is followed by a slow one: sell → eat → dance → wander → sauna → sing.',
    steps: [
      { t: '09:00', place: null, do: 'Slow breakfast at home (supermarket Karelian pies + coffee), then build and stock Emma\'s tray. Buy the HSL day ticket.' },
      { t: '10:30', place: 'bauchladen', do: 'Bauchladen: Emma sells her tray to Saturday shoppers. The takings pay for karaoke drinks.' },
      { t: '11:45', place: 'queem', do: 'The Vietnamese buffet at Quê Em — the one fixed point.' },
      { t: '13:15', place: 'senate', do: 'Dance video on the Cathedral steps.' },
